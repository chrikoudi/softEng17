...
export class ResultsComponent implements OnInit {
  events: Event[] = [
    ...
    new Event('Kidzland5','this is the fifth event.this is the fifth event.this is the fifth event.this is the fifth event.this is the fifth event.this is the fifth event.this is the fifth event.this is the fifth event.', '../../assets/images/img5.jpg'),
    new Event('Kidzland6','this is the sixth event.this is the sixth event.this is the sixth event.this is the sixth event.this is the sixth event.this is the sixth event.this is the sixth event.this is the sixth event.', '../../assets/images/img6.jpg'),
    new Event('Kidzland7','this is the seventh event.this is the seventh event.this is the seventh event.this is the seventh event.this is the seventh event.this is the seventh event.this is the seventh event.this is the seventh event.', '../../assets/images/img7.jpg')
  ];
